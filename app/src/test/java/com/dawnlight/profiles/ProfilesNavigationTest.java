package com.dawnlight.profiles;
...
import com.dawnlight.ProfilesActivity;
...
public class ProfilesNavigationTest {
    ...
    private void prepareEnvironment() {
        ...
        android.content.ComponentName cn = new android.content.ComponentName(ctx, com.dawnlight.computers.ComputerManagerService.class);

        // We only need a mock binder, not the real service
        com.dawnlight.computers.ComputerManagerService.ComputerManagerBinder binder = mock(com.dawnlight.computers.ComputerManagerService.ComputerManagerBinder.class);

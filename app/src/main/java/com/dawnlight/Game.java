...
import static com.dawnlight.StartExternalDisplayControlReceiver.requestFocusToExternalDisplayControl;
import static com.dawnlight.binding.input.KeyboardTranslator.getModifier;
import static com.dawnlight.utils.ExternalDisplayControlActivity.SECONDARY_SCREEN_NOTIFICATION_ID;
import static com.dawnlight.utils.ExternalDisplayControlActivity.closeExternalDisplayControl;
...
import com.dawnlight.binding.input.virtual_controller.keyboard.KeyBoardController;
import com.dawnlight.binding.input.virtual_controller.keyboard.KeyBoardLayoutController;
import com.dawnlight.binding.video.CrashListener;
import com.dawnlight.binding.video.MediaCodecDecoderRenderer;
import com.dawnlight.binding.video.MediaCodecHelper;
import com.dawnlight.binding.video.PerfOverlayListener;
import com.dawnlight.nvstream.NvConnection;
import com.dawnlight.nvstream.NvConnectionListener;
import com.dawnlight.nvstream.StreamConfiguration;
...
import com.dawnlight.preferences.GlPreferences;
import com.dawnlight.preferences.PreferenceConfiguration;
import com.dawnlight.profiles.ProfilesManager;
import com.dawnlight.ui.ExternalControllerView;
import com.dawnlight.ui.GameGestures;
import com.dawnlight.ui.StreamView;
import com.dawnlight.utils.Dialog;
import com.dawnlight.utils.ExternalDisplayControlActivity;
import com.dawnlight.utils.MouseModeOption;
import com.dawnlight.utils.PanZoomHandler;
    ...
    public boolean handleDeleteSurroundingText(int beforeLength, int afterLength) {
        ...
        if (beforeLength > 0) {
            ...
            for (int i = 0; i < beforeLength; i++) {
                conn.sendKeyboardInput(backspaceCode, com.dawnlight.nvstream.input.KeyboardPacket.KEY_DOWN, (byte)0, (byte)0);
                conn.sendKeyboardInput(backspaceCode, com.dawnlight.nvstream.input.KeyboardPacket.KEY_UP, (byte)0, (byte)0);
            }
        }
        return true;
    }
